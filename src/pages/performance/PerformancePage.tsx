...
const PerformancePage: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6 animate-fade-in text-slate-800 dark:text-slate-200">
      ...
      {/* Tabs */}
      <div className="border-b border-slate-200 dark:border-slate-700 flex gap-4 overflow-x-auto min-w-0">
